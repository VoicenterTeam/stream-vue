...
A VueJS component for cloudflare streaming. Uses [HSL](https://www.npmjs.com/package/hls.js/v/canary) for playing
...
```shell
$ npm i @voicenter-team/stream-vue
```

Using yarn:

```shell
$ yarn add @voicenter-team/stream-vue
```
...
```js
import VideoStream from '@voicenter-team/stream-vue'

Vue.use(VideoStream)
```

This will register global component named `<VideoStream>`
